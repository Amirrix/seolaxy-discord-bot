/**
 * Discord Role Constants
 * Centralizes all role IDs for easy management
 */
...
module.exports = {
  ...
  // Second server (SEOLAXY EN) roles
  SECOND_SERVER_UNVERIFIED: "1410999286577107064",
  SECOND_SERVER_VERIFIED: "1410999323595899121",

  // Mentorship #2 server roles
  MENTORSHIP2_VERIFIED: "1463973624410275892",
};
